...
--
-- Client :  localhost
-- Généré le :  Dim 29 Mai 2022 à 15:50
...
INSERT INTO `licencie` (`numlicencie`, `nomlicencie`, `prenomlicencie`, `sexelicencie`, `datedenaissance`, `photolicencie`, `categorielicencie`, `positionlicencie`, `adr_licencie`, `adr_ville_licencie`, `tel_licencie`, `mail_licencie`, `nationalite_licencie`, `classification_licence`, `validite_CM`, `annee_reprise`, `premiere_licence`) VALUES
(3, 'hochede', 'matteo', 'masculin', '2022-05-12', 'assets/uploads/licencie/hochede_licencie.jpg', 'adulte', 'haut', '191 RUE COLETTE RENARD', 'samer', '0698527678', 'matteo.hochede62@gmail.com', 'franÃ§ais', 'regional', '2022-05-17', 2022, 2020);
...
--
ALTER TABLE `licencie`
  MODIFY `numlicencie` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
